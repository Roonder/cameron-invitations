...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
    ...
    return (
        <>
            ...
            <Image src={"/assets/corner-vines.png"} width={120} height={60} alt="Decorative Vines" className="absolute -top-8 left-1/2 -translate-x-1/6 " />
            <Image src={"/assets/corner-vines.png"} width={120} height={60} alt="Decorative Vines" className="absolute -top-8 right-1/2 -translate-x-1/4 horizontal-reflect " />
            <Image src={"/assets/corner-vines.png"} width={120} height={60} alt="Decorative Vines" className="absolute right-0 horizontal-reflect" />
            ...
            <Image src={"/assets/corner-vines.png"} width={120} height={60} alt="Decorative Vines" className="absolute -bottom-8 left-1/2 -translate-x-1/6 vertical-reflect" />
            <Image src={"/assets/corner-vines.png"} width={120} height={60} alt="Decorative Vines" className="absolute -bottom-8 right-1/2 -translate-x-1/4 double-reflect" />
        </>
    );
});
