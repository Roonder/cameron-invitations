...
export const FinalPage = forwardRef(({
    ...
    return (
        <PageLayout ref={ref} click={click} {...props}>
            ...
            <div className="w-full h-28 p-2 absolute -translate-y-[50%] top-[50%] bg-inv-white border-2 border-inv-brown text-center">
                ...
                <h1 className={`${great_vibes.className} text-4xl mt-3 flex items-center justify-center gap-4`}>
                    <span>Te</span><span>Esperamos</span>
                </h1>
                <p className="text-xs text-wrap">y recuerden, los niños descansando plácidamente en casa...</p>
            </div>
