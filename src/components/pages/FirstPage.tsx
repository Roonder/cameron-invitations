    ...
    return (
        <PageLayout ref={ref} {...props}>
            <div className="py-10">
                ...
                <p className="text-xs w-full px-4 mb-2 text-justify">Nos reuniremos en el encantador <span className="font-semibold">Salón de Fiestas Plaza Real,</span> situado en el <span className="font-semibold">Centro Comercial Castillejo - Piso 1</span> en <span className="font-semibold">Guatire.</span> Para su comodidad, pueden encontrar la ubicación en este enlace:
                </p>

                <div className="w-full justify-center flex gap-x-4">
                    <Image src={"/assets/lady-drink-left.svg"} width={20} height={20} alt="Decorative Vines" className="" />
                    <MapButton />
                    <Image src={"/assets/lady-drink-right.svg"} width={20} height={20} alt="Decorative Vines" className="" />
                </div>
            </div>
        </PageLayout>
    );
