    ...
    return (
        <PageLayout ref={ref} {...props}>
            <div className="py-10">
                ...
                <p className="text-xs w-full px-4 mb-2 text-justify">Prepárense para un acontecimiento que sacudirá los cimientos de la sociedad. La joven señorita <span className={`${great_vibes.className} text-2xl`}>Cameron Angely</span> está a punto de deslumbrarnos con su debut en la sociedad. La familia Escobar-Martínez ha organizado una velada que promete ser el tema de conversación de toda la temporada.</p>
